...
<script type="text/javascript">
	window.onload = function() {
		document.getElementById('commentsubmit').onclick = function() {
            ...
            url += '&writer='+encodeURIComponent(document.commentfrm.writer.value.trim());
            url += '&password='+document.commentfrm.password.value.trim();
            url += '&content='+encodeURIComponent(document.commentfrm.content.value.trim());
